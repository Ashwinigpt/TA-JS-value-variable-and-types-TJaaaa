...
let integers1 = +prompt("Enter integers1");
let integers2 = +prompt("Enter integers2");
if (integers1 > integers2) {
  alert(`${integers1} is larger number`)
} else {
  alert(`${integers2} is larger number`)
}
...
let sign = prompt("Enter any sign");
if(sign == "+") {
